...
type QueueStatus = "pending" | "approved" | "changes_requested" | "rejected";

const moderationActions = [
  { label: "Approve", intent: "success", description: "Move reviewed stories into published state.", nextStatus: "approved" },
